...
public class BotMoveTaskListener implements Listener {
    ...
    public void onNavigationComplete(NavigationCompleteEvent event) {
        ...
        BotLogger.debug(task.getIcon(), true, task.getBot().getId() + " ✅ Навигация завершена (BotMoveTaskListener), ID: " + task.getUUID());
    ...
    public void onNavigationCancel(NavigationCancelEvent event) {
        ...
        BotLogger.debug(task.getIcon(), true, task.getBot().getId() + " ❌ Навигация отменена (BotMoveTaskListener) — NPC не смог дойти");
        task.stop();
    }
