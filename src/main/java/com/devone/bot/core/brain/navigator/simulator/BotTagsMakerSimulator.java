...
public class BotTagsMakerSimulator {
    ...
    public static BotSimulatorResult reachableFindBestYaw(BotPosition bot, List<BotBlockData> allBlocks, double fov, int radius, int height) {
        ...
        res.reachables = bestReachable;
          ...
          for (int yawInt = 0; yawInt < 360; yawInt++) {
            ...
            BotPosition botCopy = new BotPosition(
