...
import com.devone.bot.core.task.reactive.container.BotReactiveFishInWaterContainer;
...
public class BotStrategyFishInWater implements IBotStrategyReaction {
    ...
    public Optional<Runnable> check(Bot bot) {
        ...
        return Optional.of(() -> BotTaskManager.push(bot, new BotReactiveFishInWaterContainer(bot)));
    }
