package com.devone.bot.core.logic.tasks.talk;
...
import com.devone.bot.core.logic.tasks.talk.config.BotTalkTaskConfig;

import java.util.List;
import java.util.Random;

public class BotTalkTask extends BotTask {

    @SuppressWarnings("unused")
    private final Player player;
    private final TalkType type;
    private final Random random = new Random();
    private static final BotTalkTaskConfig config = new BotTalkTaskConfig();
    ...
    public BotTalkTask(Bot bot, Player player, TalkType type) {
        super(bot, "  💬 ");
        this.player = player;
        this.type = type;
        this.chat = new BotChat(bot); // Инициализация BotCommunicator
        setObjective("Say");
    }
