    ...
    if (!cells[8].innerHTML.trim()) {
        cells[8].innerHTML = `
            <div class="bot-position-cell">
                ...
                <button class="cmd-btn" data-bot="${bot.id}" data-cmd="bot-tp-spawn">🏡</button>
                ...
                <button class="cmd-btn" data-bot="${bot.id}" data-cmd="bot-radius-inc">◻️</button>
                <button class="cmd-btn" data-bot="${bot.id}" data-cmd="bot-radius-dec">▫️</button>
                <button class="cmd-btn" data-bot="${bot.id}" data-cmd="bot-calibrate">⚙️</button>
